...
local shitLabel = "Vortex Executor V1 - By fahri"
local lastscript = ""
--Properties:

SynapseXreal.Name = shitLabel
...
local function ReadError(get)
local s,e = pcall(function()
      get()
end)

if not s then
    Source.Text = "-- Vortex Executor - An error was detected in your script. \n--[[\n" .. tostring(e) .. "\n]]"
  end
end
...
execute.MouseButton1Click:Connect(function()
    ...
    if injected == false then
        title.Text = shitLabel .. " (not injected! press attach)"
    end
end)
...
Attach.MouseButton1Click:Connect(function()
    print("hi")
    if injected == true then
        title.Text = shitLabel .. " (already injected!)"
        wait(1)
        title.Text = shitLabel
    end
    if injected == false then
...
title_2.ZIndex = 14
title_2.Image = "http://www.roblox.com/asset/?id="
...
title_3.Text = "Vortex Executor - Script Hub"
...
execute_2.MouseButton1Click:Connect(function()
    if injected == true then
        ...
        elseif scriptselected == "spy" then
            loadstring(game:HttpGet("https://pastebin.com/raw/u62hTuwR"))()
        elseif scriptselected == "dumper" then
            saveinstance()
        elseif scriptselected == "esp" then
...
title_4.ZIndex = 110
title_4.Image = "http://www.roblox.com/asset/?id="
...
while true do
    ...
    if scripthub_2.Visible == true then
        if scriptselected == "dex" then
            descri.Text = "A version of the popular Dex explorer with patches specifically for Vortex Executor."
        elseif scriptselected == "esp" then
